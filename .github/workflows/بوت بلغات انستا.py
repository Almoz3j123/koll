...
token = "7700344369:AAExr9dJnXEEN74xLW_WlqCASGW4qtAqj4M"
...
def buttons():
    ...
    ProgrmmerCh = telebot.types.KeyboardButton("قناة المبرمج")         
...
المبرمج :* [المزعج الحاكم](t.me/Z_Y_Y_S)""",
...
@bot.message_handler(func=lambda message: message.text in ["الوقت", "طريقة الاستخدام", "انواع البلاغ", "المبرمج", "قناة المبرمج", "رجوع", "بدء البلاغ","ارسال مرة اخرى"])
def Work(message):
        text = message.text
        if text == "بدء البلاغ":
            typeReport(message)
...
def programmer(message):
    text = """
*تمت برمجة البوت بواسطة المبرمج وطن :* [المزعج الحاكم](t.me/Z_Y_Y_S) """
    bot.reply_to(
    message,text,
    parse_mode="Markdown",
    disable_web_page_preview=True
...
def programmerCh(message):
    text = """
*تمت برمجة البوت بواسطة المبرمج وطن :* [المزعج الحاكم](t.me/Z_Y_Y_S)
* قناة المبرمج :* [قناتي ](t.me/XAlmoz3j)
 """
    bot.reply_to(
    message,text,
    parse_mode="Markdown",
...
*المبرمج :* [المزعج الحاكم](t.me/Z_Y_Y_S)
*قناة المبرمج :* [My channel](t.me/XAlmoz3j)
